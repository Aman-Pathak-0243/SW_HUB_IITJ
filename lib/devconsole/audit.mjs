...
// Minimal RFC-4180-ish quoting: wrap in quotes + double embedded quotes when a field
// contains a comma, quote, or newline. Used for the Action Log / Change History
// download. Bulk export carries the same data-minimized columns as the LIST view
// (who/what/when + summary) — NOT ip / user-agent / before-after (DL-047).
