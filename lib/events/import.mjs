...
export async function importEvents(opts = {}, actor = SYSTEM_ACTOR) {
  ...
  // media inventory via the ONE shared writer (lib/media/service.mjs): dedups
  // non-base64 refs by natural key; per DL-039 each base64 placeholder stays a
  // DISTINCT row (audit-bypassing — the helper defaults to prismaBase).
