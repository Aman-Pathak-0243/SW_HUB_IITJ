...
export const POSITIONS = [
  ...
  // Council-level student representative for the PG cohort (Sports Coordinators
  // notification, AY 2026-27) — a council role, so it is not tied to any one club.
  { key: "pg_representative", name: "PG Representative", appliesToType: "council", holderKind: "student", maxHolders: null, rank: 48, isLead: false },
  // Club
  ...
  // Staff member attached to a club as its administrative anchor (2026-27 roster).
  // Ranks below the student coordinators — a support role, not a lead.
  { key: "club_associate", name: "Club Associate", appliesToType: "club", holderKind: "staff", maxHolders: null, rank: 22, isLead: false },
  // Hostel
