...
export const HOSTELS = [
  {
    ...
    roles: [
      ...
      { position: "hostel_secretary", name: "Anz Hostel_hostel_secretary" },
  ...
  },
  {
    ...
    roles: [
      ...
      { position: "hostel_secretary", name: "Yash Kumar", email: "2024uma0234@iitjammu.ac.in" },
  ...
  },
  {
    ...
    roles: [
      ...
      // until a new appointment is announced.
      { position: "hostel_secretary", name: "Mishthi Agarwal", photo: "/hostel secretary girls.jpg" },
  ...
  },
  {
    ...
    roles: [
      ...
      { position: "hostel_secretary", name: "Sawan Puri", email: "2025uch0006@iitjammu.ac.in" },
      { position: "wellness_warden", name: "Sumit Raj Ghosh", phone: "+91 9709111227", photo: "https://res.cloudinary.com/dveqd1vm1/image/upload/v1771709345/sumit_kikdod.jpg" },
  ...
  },
  {
    ...
    roles: [
      ...
      // Same interim holder as Egret — see the note there.
      { position: "hostel_secretary", name: "Mishthi Agarwal", photo: "/hostel secretary girls.jpg" },
