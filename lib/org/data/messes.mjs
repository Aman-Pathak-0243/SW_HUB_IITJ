...
// roster, preserving each V1 title in title_override (DL-035). Every committee row
// is a `mess_committee_member`.
//
// SECRETARIES are per-mess (AY 2026-27): the secretary posts are assigned by area
// (1C Annapurna; 1A & 1B Canary/Dedhar/Egret), so each mess carries its own
// `secretary` and the singleton `mess_secretary` is held once PER MESS UNIT. The
// old campus-wide committee "Mess Secretary" row is gone — it would have collided
// with the first mess unit's own secretary.
...
export const MESSES = [
  { name: "Annapurna Mess (2nd Floor)", slug: "annapurna-mess-2nd-floor", location: "Fulgar – 1C", capacity: "360 students", image: "https://res.cloudinary.com/dabviijid/image/upload/v1774694949/DSCF3139.JPG_dhofqc.jpg", secretary: { name: "Sunil Kumar", email: "2025psp0011@iitjammu.ac.in", titleOverride: "Mess Secretary — 1C (Annapurna)" } },
  { name: "Annapurna Mess (3rd Floor)", slug: "annapurna-mess-3rd-floor", location: "Fulgar – 1C", capacity: "360 students", image: "https://res.cloudinary.com/dabviijid/image/upload/v1774694949/DSCF3147.JPG_gb4kfv.jpg", secretary: { name: "Sunil Kumar", email: "2025psp0011@iitjammu.ac.in", titleOverride: "Mess Secretary — 1C (Annapurna)" } },
  { name: "Egret Mess", slug: "egret-mess", location: "1B", capacity: "470 students", image: "https://res.cloudinary.com/dabviijid/image/upload/v1774694949/DSCF3178.JPG_jhfjly.jpg", secretary: { name: "Shwet Baliyan", email: "2025uch0018@iitjammu.ac.in", titleOverride: "Mess Secretary — 1A & 1B" } },
  { name: "Canary Mess", slug: "canary-mess", location: "L-112", capacity: "240 students", image: "https://res.cloudinary.com/dveqd1vm1/image/upload/v1774081543/WhatsApp_Image_2026-03-21_at_12.53.37_m1lmqn.jpg", secretary: { name: "Shwet Baliyan", email: "2025uch0018@iitjammu.ac.in", titleOverride: "Mess Secretary — 1A & 1B" } },
  { name: "Dedhar Mess", slug: "dedhar-mess", location: "L-120", capacity: "240 students", image: "https://res.cloudinary.com/dabviijid/image/upload/v1774694949/DSCF3167.JPG_phxc3y.jpg", secretary: { name: "Shwet Baliyan", email: "2025uch0018@iitjammu.ac.in", titleOverride: "Mess Secretary — 1A & 1B" } },
];
