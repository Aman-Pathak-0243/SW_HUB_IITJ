...
// admin = the full catalog minus the developer-console / backup / migration ops
// (reserved for super_admin / developer). Computed from PERMISSION_KEYS so it can
// never drift out of sync with the catalog as new permissions are added.
const ADMIN_ONLY_EXCLUDED = new Set(["dev.console", "backup.create", "backup.restore", "media.migrate"]);
