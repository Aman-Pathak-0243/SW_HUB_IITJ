...
// Live real-time (Session 16): SSE stream connects (a viewer may reconnect a few times)
// and quiz answer submissions (one per question, ~20s apart). Per-process dampeners (#34).
export const liveStreamLimiter = makeRateLimiter({ limit: 60, windowMs: 60_000 });
export const liveAnswerLimiter = makeRateLimiter({ limit: 60, windowMs: 60_000 });
