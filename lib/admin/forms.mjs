...
export const MIN_PASSWORD_LENGTH = 8; // matches lib/auth/password.mjs
...
export function validateUserForm(input = {}, { isCreate = false } = {}) {
  ...
  if (input.password !== undefined && input.password !== "") {
    ...
    if (pw.length < MIN_PASSWORD_LENGTH) errors.password = `Password must be at least ${MIN_PASSWORD_LENGTH} characters.`;
