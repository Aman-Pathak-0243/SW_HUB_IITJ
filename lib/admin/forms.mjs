...
// M1 access modes (DL-065) — re-exported from the pure access module (single source).
...
export function validateUserForm(input = {}, { isCreate = false } = {}) {
  ...
  if (input.allowNormalView !== undefined) value.allowNormalView = !!input.allowNormalView; // M1 toggle (DL-067)
