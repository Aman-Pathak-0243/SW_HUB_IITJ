...
export const ADMIN_MODULES = [
  ...
  },
  {
    ...
    href: "/admin/users",
    icon: "users",
    description: "Accounts, role definitions & role assignments (RBAC).",
    anyOf: ["user.read", "user.create", "user.update", "user.suspend", "user.delete", "role.read", "role.create", "role.update", "role.assign", "role.revoke"],
  },
  {
    key: "requests",
