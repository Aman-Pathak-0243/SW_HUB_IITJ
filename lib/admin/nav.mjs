...
export const ADMIN_MODULES = [
  ...
  },
  {
    ...
    icon: "users",
    description: "Map each coordinator to a club — one club per coordinator, per academic year.",
    anyOf: ["role.assign", "role.read"],
  },
  {
    key: "contribution",
    label: "Contribution",
    ...
    icon: "gauge",
    description: "Per-stakeholder institute contribution across a year — member / club / custom entity (M6).",
    anyOf: ["user.read"],
  },
  {
    key: "requests",
