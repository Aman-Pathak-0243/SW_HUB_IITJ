...
- [ ] **M6 Profiles** — member profile (name/email/syndicate/roles/participation/achievements) + per-stakeholder institute contribution tracking across a year (aggregate `achievement_credit` + `event_*` by durable ids); self + admin view
